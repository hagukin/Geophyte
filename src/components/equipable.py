...
class Equipable(BaseComponent):
    ...
    def changed_status(self):
        ...
        changed_status = {
            ...
            "eq_base_melee":self.eq_base_melee + self.add_base_melee,
            "eq_additional_melee":self.eq_additional_melee + self.add_additional_melee,
            "eq_protection":self.eq_protection + self.add_protection,
            "eq_hearing":self.eq_hearing + self.add_hearing,
            "eq_eyesight":self.eq_eyesight + self.add_eyesight,
            "eq_fire_resistance":self.eq_fire_resistance + self.add_fire_resistance,
            "eq_poison_resistance":self.eq_poison_resistance + self.add_poison_resistance,
            "eq_cold_resistance":self.eq_cold_resistance + self.add_cold_resistance,
            "eq_acid_resistance":self.eq_acid_resistance + self.add_acid_resistance,
            "eq_psychic_resistance":self.eq_psychic_resistance + self.add_psychic_resistance,
            "eq_sleep_resistance":self.eq_sleep_resistance + self.add_sleep_resistance,
            "eq_shock_resistance":self.eq_shock_resistance + self.add_shock_resistance,
            "eq_magic_resistance":self.eq_magic_resistance + self.add_magic_resistance,
