...
potion_of_healing = Item(
    ...
    entity_desc=("회복의 물약은 유기체의 손상된 조직을 빠른 속도로 치유한다. "
                 "회복의 물약은 조제법만이 전해져 내려올 뿐 구체적인 작동 원리는 아직까지도 밝혀지지 않았는데, "
                 "대다수의 포션술사들은 회복의 물약이 몇 백여년 간 대대로 연구되어온 자료들이 쌓여 만들어진, 포션학의 결정체일 것이라고 추측한다. "
                 ),
    item_type_desc=("예로부터 물약은 인간, 비인간을 막론하고 다양한 지적 생명체들에게 널리 연구되어왔다. "
                    "때문에 지금은 그 종류도 굉장히 다양한데, 이 중 일부는 생명체에게 치명적인 효과를 부여하기도 한다. "
                    "물약은 빠르게 흡수되며 대부분 극도로 높은 반응성을 띄기 때문에 주로 유리병에 담아 보관한다."
                    ),
    rarity=60,
    weight=0.2,
    price=100,
...
scroll_of_confusion = Item(
    ...
    entity_desc=("혼란의 주문서를 읽은 사용자는 자신이 원하는 생명체를 선택해 그 생명체의 사고를 방해해 혼란스럽게 만들 수 있다. "
                 ),
...
scroll_of_meteor_storm = Item(
    ...
    entity_desc=("운석 폭풍의 주문서를 읽은 사용자는 자신이 원하는 공간에 거대한 운석을 소환할 수 있다. "),
    item_type_desc=("주문서들은 마법을 사용할 줄 모르거나 내재하고 있는 마력이 부족하더라도 마법을 사용할 수 있게 해주는 유용한 도구이다. "),
    rarity=12,
    weight=0.1,
    price=300,
...
scroll_of_magic_mapping = Item(
    ...
    entity_desc=("마법 지도의 주문서를 읽으면 사용자가 있는 주위 공간의 정보가 사용자의 머릿 속으로 전해져 온다. "),
    item_type_desc=("주문서들은 마법을 사용할 줄 모르거나 내재하고 있는 마력이 부족하더라도 마법을 사용할 수 있게 해주는 유용한 도구이다. "),
    rarity=40,
    weight=0.1,
    price=250,
...
scroll_of_enchantment = Item(
    ...
    entity_desc=("마법 강화의 주문서를 읽은 사용자는 보유 중인 도구에 마법 에너지를 부여해 도구의 성능을 강화할 수 있다. "),
    item_type_desc=("주문서들은 마법을 사용할 줄 모르거나 내재하고 있는 마력이 부족하더라도 마법을 사용할 수 있게 해주는 유용한 도구이다. "),
    rarity=40,
    weight=0.1,
    price=400,
...
scroll_of_identify = Item(
    ...
    entity_desc=("감정의 주문서를 읽은 사용자는 원하는 물품의 성질에 대해 더 자세하게 이해하게 된다. "),
    item_type_desc=("주문서들은 마법을 사용할 줄 모르거나 내재하고 있는 마력이 부족하더라도 마법을 사용할 수 있게 해주는 유용한 도구이다. "),
    rarity=60,
    weight=0.1,
    price=50,
...
scroll_of_teleportation = Item(
    ...
    entity_desc=("순간 이동의 주문서를 읽은 사용자는 물리적으로 떨어진 공간으로 순간 이동을 할 수 있는 고위 마법을 한 차례 사용할 수 있게 된다. "
                 "간혹 주문서의 상태 등에 의해 불안정한 이동을 하는 경우도 존재한다. "
                 ),
    item_type_desc=("주문서들은 마법을 사용할 줄 모르거나 내재하고 있는 마력이 부족하더라도 마법을 사용할 수 있게 해주는 유용한 도구이다. "),
    rarity=40,
    weight=0.1,
...
lightning_bolt_spellbook = Item(
    ...
    item_type_desc=("마법서는 단순한 책들과는 격을 달리 하는 물건이다. "
                    "이들은 막대한 마법 에너지를 사용해 작성되었으며, 그 내용도 쉽게 이해하기 어려운 경우가 많다."),
    rarity=2,
    weight=0.85,
    price=480,
...
leather_armor = Item(
    ...
    entity_desc=("질긴 가죽을 덧대 만든 갑옷이다. 착용한다면 어느 정도 보호를 제공해줄 수 있을 것 같다."),
    rarity=5,
    weight=4.5,
    price=300,
    item_type=InventoryOrder.ARMOR,
...
swordstick = Item(
    ...
    entity_desc="화려한 보석들로 치장된 지팡이로, 손잡이 부분을 당겨 긴 날이 달린 검을 뽑을 수 있다. ",
    rarity=3,
    weight=0.62,
    price=350,
    item_type=InventoryOrder.MELEE_WEAPON,
...
amulet_of_kugah = Item(
    ...
    entity_desc="몰록의 위협으로부터 인류를 해방시킬 수단이자, 인간이 쿠가를 깨워 도움을 요청할 수 있는 유일한 방법이다.",
    rarity=0,
    weight=0.2,
    price=0,
