...
char="▄",# bottom half block (ascii)
    ...
    name=i("제단","altar"),
    entity_id="altar",
    entity_desc=i("종교 제사에 사용되는 제단이다. 악마들린 물건을 식별할 때 사용된다.",
                  "A flat table that is used in some religious ceremonies. Can be used to distinguish cursed objects from the rest."),
    do_action=False,
...
oak_tree = SemiActor(
    ...
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Default(flammable=0.9, corrodable=0.01),
    blocks_movement=False,
    blocks_sight=True,
    rule_cls=None,
    trigger_bump=False,
...
cactus = SemiActor(
    ...
    safe_to_move=False,
    semiactor_info=semiactor_info.Default(flammable=1, corrodable=0.3),
    blocks_movement=False,
    blocks_sight=False,
    rule_cls=None,
    trigger_bump=False,
...
closed_door = SemiActor(
    ...
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Door(flammable=1, corrodable=0.1),
...
locked_door = SemiActor(
    ...
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Door(flammable=0.5, corrodable=0.1, unlock_chance=1),
    blocks_movement=True,
    blocks_sight=True,
    rule_cls=None,
    trigger_bump=True,
...
chained_locked_door = SemiActor(
    ...
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Door(flammable=0.2, corrodable=0.02, break_str_req=(20,25), unlock_chance=0.7),
    blocks_movement=True,
    blocks_sight=True,
    rule_cls=None,
    trigger_bump=True,
