...
locked_door = SemiActor(
    ...
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Door(flammable=0.2, corrodable=0.1),
    blocks_movement=True,
    blocks_sight=True,
    rule_cls=None,
    trigger_bump=True,
...
chained_locked_door = SemiActor(
    ...
    entity_desc="description of chained locked door",
    do_action=False,
    walkable=None,
    safe_to_move=True,
    semiactor_info=semiactor_info.Door(flammable=0, corrodable=0.02, break_str_req=(20,25)),
    blocks_movement=True,
    blocks_sight=True,
    rule_cls=None,
    trigger_bump=True,
